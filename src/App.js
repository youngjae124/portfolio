...
const quickFacts = [
  { label: '포지션', value: 'Frontend to Backend' },
  { label: '프로젝트', value: 'Team Project 3' },
  { label: '중점', value: 'Flow / Structure / Growth' },
];

const aboutItems = [
  { label: '한 줄 소개', value: '사용자 흐름과 구조 설계를 함께 고민하는 개발자' },
  { label: '관심사', value: 'React 기반 UI, 협업형 서비스, 확장 가능한 구조' },
  { label: '강점', value: '화면 구현에서 시작해 백엔드 계층과 DB 구조까지 확장한 경험' },
...
const skillGroups = [
  ...
  {
    title: 'Backend',
    items: ['Java 11', 'Spring MVC', 'Spring JDBC', 'MyBatis', 'JSP', 'JSTL', 'JWT'],
  },
  {
    title: 'Database & API',
    items: ['Oracle DB', 'LocalStorage', 'Google Calendar API'],
  },
];
...
const archivingItems = [
  {
    ...
    description: '3개의 팀 프로젝트 저장소와 구현 기록을 한곳에서 확인할 수 있습니다.',
    href: 'https://github.com/youngjae124',
    action: '프로필 보기',
  },
  {
    title: 'Project Repositories',
    subtitle: 'pet-lab / undefined / LocalQuest',
...
const projects = [
  {
    ...
    name: 'pet-lab',
    type: 'Frontend Focus',
    repoUrl: 'https://github.com/youngjae124/pet-lab',
    videoSrc: '/videos/petlab-demo.mp4',
    summary: '반려동물 커머스와 커뮤니티 경험을 연결한 React 기반 웹 프로젝트',
    stack: ['React', 'JavaScript', 'React Router DOM', 'Bootstrap', 'React Bootstrap', 'LocalStorage'],
    contributions: [
      '메인, 검색, 카테고리, 상세, 주문 흐름을 페이지 간 연결로 정리했습니다.',
      '펀딩 등록/상세/수정과 커뮤니티 게시판 흐름을 나누어 화면 구조를 설계했습니다.',
      '사용자 행동 기준으로 화면을 묶으며 프론트엔드 흐름 설계 감각을 키웠습니다.',
    ],
    takeaway: 'UI를 많이 만드는 것보다 페이지 간 연결과 재사용 구조를 먼저 잡는 습관을 배웠습니다.',
  },
  {
    phase: '2차 프로젝트',
    name: 'undefined',
    ...
    stack: ['Java 11', 'Spring MVC', 'Spring JDBC', 'MyBatis', 'Oracle DB', 'JSP', 'JSTL', 'Google Calendar API'],
    contributions: [
  ...
  },
  {
    ...
    stack: ['React', 'JavaScript', 'React Router DOM', 'React Redux', 'Redux Toolkit', 'Axios', 'Sass', 'Spring MVC', 'MyBatis', 'Oracle DB', 'JWT'],
    contributions: [
...
const timeline = [
  {
    phase: '1차',
    title: 'pet-lab',
    description: '사용자 흐름과 화면 구성을 중심으로 프론트엔드 구현 경험을 쌓았습니다.',
  },
  {
    phase: '2차',
    title: 'undefined',
      ...
      <main className="portfolio-page">
        ...
        <section className="hero-section" id="intro">
          <div className="hero-copy">
            ...
            <p className="hero-description">
              React 기반 화면 설계에서 출발해, Spring MVC와 Oracle DB를 활용한 협업형 서비스 구조까지
              경험을 확장했습니다. 세 번의 팀 프로젝트를 통해 UI 구현, 백엔드 설계, 분리형 아키텍처를
              단계적으로 쌓아온 포트폴리오입니다.
            </p>
        ...
        <section className="about-section" id="about">
          <div className="section-heading">
            ...
            <h2>프로젝트를 통해 프론트엔드와 백엔드를 함께 보는 시야를 키웠습니다.</h2>
          </div>
        ...
        <section className="projects-section" id="projects">
          <div className="section-heading">
            ...
            <h2>1차, 2차, 3차 프로젝트를 시연 영상과 함께 정리했습니다.</h2>
          </div>
